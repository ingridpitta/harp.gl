...
declare global {
    interface Set<T> {
        /**
         * Return `true` if the this set has all the elements that are in the other set.
         */
        isSuperset(subset: Set<T>): boolean;

        /**
         * Return `true` if the this set and the other set share at least a single element.
         */
